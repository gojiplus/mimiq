...
- Playwright evidence replay against a fresh page and app instrumentation for agent tool calls.
- Support for local OpenAI-compatible models, including Ollama.
